...
// Single API definition used for both namespaces
const electronApi = {
  ...
  player: {
    ...
    setAudioOnly: (_enabled: boolean) => Promise.resolve({ success: false, error: 'Audio-only mode not available' }),
...
// Expose under both namespaces (both are used across the codebase)
